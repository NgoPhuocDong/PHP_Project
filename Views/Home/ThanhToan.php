    ...
    <div class="order-details">
      <div class="left">
        <div class="left-user">
          ...
          <?php if (!empty($_SESSION['user']) && !empty($thongtin)) :
            foreach ($thongtin as $row) : extract($row); ?>
              <input type="hidden" id="id" name="idkhachhang" value="<?= $row['IDKhachHang'] ?>" required>
              <div class="mb-3">
                <label for="name" class="form-label">Họ và tên:</label>
                <input type="text" class="form-control" id="name" name="tenkhachhang" value="<?= $row['TenKhachHang'] ?>" required>
              </div>
              <div class="mb-3">
                <label for="phone" class="form-label">Số điện thoại:</label>
                <input type="text" class="form-control" id="phone" name="sodienthoai" value="<?= $row['SoDienThoai'] ?>" required>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control" id="address" name="diachi" rows="3" required><?= $row['DiaChi'] ?></textarea>
              </div>
            <?php endforeach;else : ?>
            <div class="mb-3">
              <label for="name" class="form-label">Họ và tên:</label>
